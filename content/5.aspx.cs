...
public partial class content_1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Literal1.Text += "<div id='menu1' style='background-color: rgb(" + dv.Table.Rows[4][2].ToString() + "," + dv.Table.Rows[4][3].ToString() + "," + dv.Table.Rows[4][4].ToString() + "); width:700px; height: 450px; margin: 0 auto;'>";
            ...
            Literal1.Text += "<li style='padding-top: 20px;'><a href='ck.aspx' style='color: rgb(" + dv.Table.Rows[4][8].ToString() + "," + dv.Table.Rows[4][9].ToString() + "," + dv.Table.Rows[4][10].ToString() + ");' >HOME</a></li> ";
            Literal1.Text += "<li style='padding-top: 20px;'><a href='vote.aspx' style='color: rgb(" + dv.Table.Rows[4][8].ToString() + "," + dv.Table.Rows[4][9].ToString() + "," + dv.Table.Rows[4][10].ToString() + ");'>VOTE</a></li>";
            Literal1.Text += "<li style='padding-top: 20px;'><a href='new/contact_us.aspx' style='color: rgb(" + dv.Table.Rows[4][8].ToString() + "," + dv.Table.Rows[4][9].ToString() + "," + dv.Table.Rows[4][10].ToString() + ");'>MESSAGE</a></li>";
            Literal1.Text += "<li style='padding-top: 20px;'><a href='new/download.aspx' style='color: rgb(" + dv.Table.Rows[4][8].ToString() + "," + dv.Table.Rows[4][9].ToString() + "," + dv.Table.Rows[4][10].ToString() + ");'>DOWNLOAD</a></li>";
            Literal1.Text += "<li style='padding-top: 20px;'><a href='new/about.aspx' style='color: rgb(" + dv.Table.Rows[4][8].ToString() + "," + dv.Table.Rows[4][9].ToString() + "," + dv.Table.Rows[4][10].ToString() + ");'>ABOUT US</a></li>";
            Literal1.Text += "<li style='padding-top: 20px;'><a href='new/login.aspx' style='color: rgb(" + dv.Table.Rows[4][8].ToString() + "," + dv.Table.Rows[4][9].ToString() + "," + dv.Table.Rows[4][10].ToString() + ");'>SIGN IN/UP</a></li>";
            Literal1.Text += "</ul></div><br />";
            Literal1.Text += "<div style='padding-top:20px;padding-left:20px;padding-right:20px;color: rgb(" + dv.Table.Rows[4][5].ToString() + "," + dv.Table.Rows[4][6].ToString() + "," + dv.Table.Rows[4][7].ToString() + ");line-height:1.3em;'><br />";
            Literal1.Text += "<h3 style='text-align: left; color: rgb(" + dv.Table.Rows[4][5].ToString() + "," + dv.Table.Rows[4][6].ToString() + "," + dv.Table.Rows[4][7].ToString() + "); border-bottom:solid 1px;padding-bottom:0.5em;letter-spacing:0.5em;'>關於我們</h3>";
